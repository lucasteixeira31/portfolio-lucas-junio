...
gdjs.evtsExt__CursorType__DoChangeCursorType.userFunc0xb8dd78 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
const cursorType = eventsFunctionContext.getArgument("CursorType");
const customCursorTypes = {
  default: 'url("assets/icons/cursor-game.png") 19 5, auto',
  auto: 'url("assets/icons/cursor-game.png") 19 5, auto',
  pointer: 'url("assets/icons/pointer-game.png") 20 4, pointer',
};

const cursorEscolhido = customCursorTypes[cursorType] || cursorType;
const canvas = runtimeScene.getGame().getRenderer().getCanvas();

if (canvas) {
  canvas.style.setProperty("cursor", cursorEscolhido, "important");
}
...
gdjs.evtsExt__CursorType__DoChangeCursorType.userFunc0xb8dd78(runtimeScene, eventsFunctionContext);
