...
gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.idToCallbackMap = new Map();
...
for (var i = 0, k = 0, l = gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3[i].isCollidingWithPoint((( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3.length === 0 ) ? 0 :gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3[0].getX()) + eventsFunctionContext.getArgument("CellWidth"), (( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3.length === 0 ) ? 0 :gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3[0].getY())) ) {
...
gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3.length = k;
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3[i].isCollidingWithPoint((( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3.length === 0 ) ? 0 :gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3[0].getX()) + eventsFunctionContext.getArgument("CellWidth") / 2, (( gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3.length === 0 ) ? 0 :gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDObjectObjects3[0].getY()) + eventsFunctionContext.getArgument("CellHeight") * 3 / 4) ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3[k] = gdjs.evtsExt__LinkTools__LinkHexagonalNeighbors.GDNeighborObjects3[i];
        ++k;
    }
